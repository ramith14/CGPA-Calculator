// ============================================
// GPA / CGPA Calculator - Basic JavaScript
// ============================================
...
// --------------------------------------------
// Add a subject to current semester
// --------------------------------------------
function addSubject(isFuture) {
  ...
  if (name === "" || isNaN(credits) || isNaN(gradePoints)) {
...
// --------------------------------------------
// GPA calculation for a list of subjects
// --------------------------------------------
...
// --------------------------------------------
// Get total credits from semester list
// --------------------------------------------
...
function renderSemestersOverview() {
  ...
  // Future semesters (only if what-if is on)
  var whatIfEnabled = document.getElementById("whatIfMode").checked;
  if (whatIfEnabled) {
    for (i = 0; i < futureSemesters.length; i++) {
...
// --------------------------------------------
// Create a semester overview card
// --------------------------------------------
function createSemesterCard(name, gpa, credits, subjectCount, isFuture, index, isActive) {
  ...
  info.innerHTML =
    ...
    "<p>" + subjectCount + " subjects | " + credits + " credits | GPA: " + gpa.toFixed(2) + "</p>";
